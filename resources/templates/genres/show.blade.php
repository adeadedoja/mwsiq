...
$(document).ready(function(){
	...
	<div class="info">
		...
		<div class="col-md-7 col-xs-6">
			<div class="info_ii">
									<h2>{{$genre->name}}</h2>
				   					<a class="ass"><i class="icon-backward jp-previous pre" role="button" tabindex="0"></i><i class="icon-play-circle jp-play pl" role="button" tabindex="0"></i><i class="icon-pause jp-pause pl" role="button" tabindex="0"></i><i class="icon-forward jp-next next" role="button" tabindex="0"></i></a>
	...
	<h3 class="col">{{$genre->name}} songs</h3>
			<ul>
				<li>&nbsp;</li>
			</ul>
		</div>
